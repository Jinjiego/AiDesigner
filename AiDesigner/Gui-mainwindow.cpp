...
void MainWindow::setupToolBar()
{
    ...
    myToolBar->addAction(QIcon(":/res/Images/new.png"),"New");
...
void MainWindow:: CreateProjectDockWidget(){
 ...
 void MainWindow::CreateMessagesDockWidget(){
        ...
        /////////////////////////////////////////////////////////////////////////////
         BLLMesgManager *messagesManager = new BLLMesgManager(0,"start message");
 ...
 void MainWindow::CreateProgressDockWidget(){
                 ...
                 ProgressDockWidget->setWidget(curProjectLabel);
                 //*******************
